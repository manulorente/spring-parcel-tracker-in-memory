...
CREATE TABLE IF NOT EXISTS INVOICES (
    ...
    CONSTRAINT FK_INVOICE_CUSTOMER_INFO FOREIGN KEY (CUSTOMER_INFO_ID) REFERENCES ADDRESSES(ID)
);
...
CREATE TABLE IF NOT EXISTS DELIVERIES (
    ...
    CONSTRAINT FK_DELIVERY_SOURCE FOREIGN KEY (SOURCE_ID) REFERENCES ADDRESSES(ID),
    CONSTRAINT FK_DELIVERY_DESTINATION FOREIGN KEY (DESTINATION_ID) REFERENCES ADDRESSES(ID),
